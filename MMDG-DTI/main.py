...
if __name__ == "__main__":
    ...
    for epoch in range(1, iteration):
        ...
        AUC_test, precision_test, recall_test, AUC2, AUC3 = tester.test(dataset_test, p_LMs, d_LMs)

        end = timeit.default_timer()
        time = end - start

        AUCs = [epoch, time, loss_train,
                AUC_test, precision_test, recall_test, AUC2, AUC3]
...
# 10	6281.631627505005	956.4187350422144	0.9546648272879869	0.8837042354630295	0.9563387346864018
